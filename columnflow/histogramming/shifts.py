    ...
    if self.dataset_inst.is_mc and len(events):
        ...
        if self.subshift_insts:
            ...
            for subshift_inst in self.subshift_insts:
                #if subshift_inst in self.sel_subshift_insts: 
                #    print(f"Skipping shift-dependent {subshift_inst}")
                #    continue

                if _weight_debug: print(f"Handling {subshift_inst}")
                ...
                if _weight_debug: print(subshift_weight)
